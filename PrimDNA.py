...
class PrimDNA:
    ...
    def _decode(self, hex_gene, num_inputs, num_internals, num_outputs):
        ...
        nn_dict = {
            ...
            'weight': int(bin_gene_str[16:32], 2) / 32767  # normalized to range between -1.0 to 1.0
        }
...
Bit 16 - 31 : Signed 16-bit integer value of weight
For example -> [0][1110101][0][1011101][01101010...//16-bit...01011]
'''
def decode(hex_gene, num_inputs, num_internals, num_outputs):
...
if __name__ == "__main__":
    dna = PrimDNA(4)
    print("[DEBUG] DNA to string:",dna.to_string(pretty=True))
    print("[DEBUG] Gene decoded:", decode("0fa97bc0", 6, 3, 2))